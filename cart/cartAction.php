...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){
        ...
        $redirectLoc = $insertItem?'../product_summary.php?id='.$itemData['id'].'':'../product.php';
        ...
        // $query="UPDATE products SET stock=stock-$c where id='".$id."'";
        ...
        if($insertOrder){
            ...
            foreach($cartItems as $item){
                ...
                $q=$item['qty'];
                           ...
                           $query=$db->query("UPDATE products SET stock=stock-'$q' WHERE id='".$pid."'"); 
