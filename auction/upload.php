...
*/
   ...
   $end = mysqli_real_escape_string($db, $_POST['end']);
  	...
  	$query = "INSERT INTO auction (title,  price, description, vid,start,end,image1) VALUES ('$title','$price','$description','$vid','$start','$end','$image1')";
  			  //$query;
  	if(mysqli_query($db, $query)){
        header('location: http://localhost/dcandah/auction_bidproduct.php#Upload_Sucessful');
