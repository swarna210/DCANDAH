...
<nav class="navbar navbar-expand-lg navbar-dark ">
  ...
  <div class="collapse navbar-collapse" id="main_nav">
    ...
    <section class="feature_product_area" style="margin-left:50px;margin-top:50px;">
        	<div class="main_box">
				<div class="container">
<div class="feature_product_inner">
         ...
         <!--<h3 style="text-align:center;margin-bottom:30px;">What's New<br>
		    ...
		    $ro = $result->num_rows;
			$query = $db->query("SELECT * FROM auction ORDER BY id DESC LIMIT 9");
			if($query->num_rows > 0){ 
...
$n = date( 'Y/m/d h:i:s', strtotime("now"));
$end=$row['end'];*/
                date_default_timezone_set('Asia/Kolkata');

$curDateTime = date("Y-m-d H:i:s");
$myDate = date("Y-m-d H:i:s", strtotime($row['end']));
/*
  ...
  <a class="card-img-top">
      <?php  echo "<img src='auction/bidpics/".$row['image1']."' style='width:200px; height:200px;border-radius:50px 20px; margin-left:40px;  border: 6px solid #660044;'>"; ?>
        </a>
  <div class="card-body">
   <h5 class="card-title" ><a >
        <?php
             if($myDate < $curDateTime){
                ...
                {
                 echo "<h4   style='color: #800040;font-family:Lucida Bright;font-size:20px;'>".$row['title']."</h4>";    
      ...
      <?php
             if($myDate < $curDateTime){
                ...
                {?>
                    <p class="card-text"><?php echo "<h5 style='color: #800040;font-family:Lucida Bright;font-size:20px;' >₹ ".$row['price']."</h5>" ; ?>
      </p><?php } ?>
            <!----->
      <?php
             if($myDate < $curDateTime){
                ...
                {?>
    <p class="card-text"><?php echo "<h5 style='color: #800040;font-family:Lucida Bright;font-size:20px;' >start: ".$row['start']."</h5>" ; ?></p>  
      <?php } ?>
      <!----->
      <?php
             if($myDate < $curDateTime){
                ...
                {?>
    <p class="card-text"><?php echo "<h5 style='color: #800040;font-family:Lucida Bright;font-size:20px;' >end: ".$row['end']."</h5>" ; ?></p> 
      <?php } ?>
            <!----->
<?php
             if($myDate < $curDateTime){?>
           <a href="auction_picdetails.php?id=<?php  echo $row['id'];?>" class="btn " style="margin-bottom:10px;color:white; background-color:#800040;">Show Details</a>     
            <?php }
                else
                {?>
    <a href="auction_picdetails.php?id=<?php  echo $row['id'];?>" class="btn " style="margin-bottom:10px;color:white; background-color:#800040;">Bid Here</a>
      <?php } ?>
                  <!----->
  </div>
          </div>
